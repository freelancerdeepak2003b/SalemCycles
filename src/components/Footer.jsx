  ...
  return (
    <footer className="site-footer">
      ...
      <div className="container site-footer__grid">
        {/* Brand column with Logo & Direct WhatsApp CTA */}
        <div className="site-footer__brand">
          <Link to="/" className="site-footer__logo-link">
            <img
              src={logoImg}
              alt="Salem Cycles Logo"
          ...
          {/* WhatsApp CTA directly below Brand info */}
          <a
        ...
        <div className="site-footer__col">
          ...
          <ul className="footer-contact">
            ...
            <li className="footer-social-row">
              {/* Instagram */}
              <a
                href={SITE.instagramUrl || "https://instagram.com"}
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Facebook */}
              <a
                href={SITE.facebookUrl || "https://facebook.com"}
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
                aria-label="Facebook"
      ...
      <div className="site-footer__bottom">
        <div className="container site-footer__bottom-inner">
          <p>© {year} Salem Cycles. Built for smooth journeys.</p>
          <div className="site-footer__tags">
            <span>Sales</span> • <span>Service</span> • <span>Custom Builds</span>
          </div>
        </div>
      </div>
    </footer>
